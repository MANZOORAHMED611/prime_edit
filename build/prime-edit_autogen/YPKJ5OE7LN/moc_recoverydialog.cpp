...
#include <memory>
#include "../../../src/ui/recoverydialog.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_RecoveryDialog_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_RecoveryDialog_t qt_meta_stringdata_RecoveryDialog = {
    {
QT_MOC_LITERAL(0, 14) // "RecoveryDialog"
...
const QMetaObject RecoveryDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_RecoveryDialog.offsetsAndSize,
    qt_meta_data_RecoveryDialog,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_RecoveryDialog_t
, QtPrivate::TypeAndForceComplete<RecoveryDialog, std::true_type>
